            ...
            {this.props.pods.map(pod =>
              <tr key={pod.id} className={pod.complete ? '' : 'success'}>
                ...
                <td className="text-right">
                  ...
                  <button onClick={this.props.deletePod} className={!pod.is_owner ? "hidden" : "btn btn-xs btn-danger margin_left"} data-podid={pod.id} data-playerid={pod.player_id}>Delete</button>
                </td>
              </tr>
            )}
          </tbody>
